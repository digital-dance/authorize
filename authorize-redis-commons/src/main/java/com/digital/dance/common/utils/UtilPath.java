...
public class UtilPath {
	...
	private static final ThreadLocal<HttpServletRequest> thread4HttpServletRequest = new ThreadLocal<HttpServletRequest>();

	private static final ThreadLocal<ServletResponse> thread4ServletResponse = new ThreadLocal<ServletResponse>();
	...
	public static HttpServletRequest currentRequest() {
		if(thread4HttpServletRequest.get() != null){
			return thread4HttpServletRequest.get();
		}
	...
	public static void setCurrentRequest(HttpServletRequest request) {
		thread4HttpServletRequest.set(request);
	}

	public static void setCurrentResponse(ServletResponse response) {
		thread4ServletResponse.set(response);
	}

	public static ServletResponse currentResponse() {
		if(thread4ServletResponse.get() != null){
			return thread4ServletResponse.get();
		}
		return ((ServletRequestAttributes) RequestContextHolder.currentRequestAttributes())
				.getResponse();
	}

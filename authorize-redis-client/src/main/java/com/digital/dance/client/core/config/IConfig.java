package com.digital.dance.client.core.config;
...
public class IConfig {
	 ...
	 * 配置文件名称
	 */
	private final static String FILE_NAME = "/config_permission.properties";
	
	static{
		prop = new Properties();
		try {
			prop.load(IConfig.class.getResourceAsStream(FILE_NAME));
			LoggerUtils.fmtInfo(IConfig.class, "加载文件成功，文件路径：%s", FILE_NAME);
		} catch (IOException e) {
